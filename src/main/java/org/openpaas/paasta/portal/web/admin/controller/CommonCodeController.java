...
public class CommonCodeController extends Common {
    ...
    @ResponseBody
    public Map<String, Object> getGroupDetail(@PathVariable("id") String  id, HttpServletRequest request, @ModelAttribute CommonCode param) {
        String key = request.getParameter("key");
    ...
    @ResponseBody
    public Map<String, Object> updateCommonGroup(@PathVariable String id, HttpServletRequest request, @RequestBody CommonCode param) {
        String key = request.getParameter("key");
    ...
    @ResponseBody
    public Map<String, Object> deleteCommonGroup(@PathVariable String id, HttpServletRequest request) {
        String key = request.getParameter("key");
        LOGGER.info("########## " + id);
    ...
    @ResponseBody
    public Map<String, Object> getCodeDetail(@PathVariable("no") int no, HttpServletRequest request) {
        String key = request.getParameter("key");
        LOGGER.info("NO :: " + no);
    ...
    @ResponseBody
    public Map<String, Object> updateCommonDetail(@PathVariable int no, HttpServletRequest request, @RequestBody CommonCode param) {
        String key = request.getParameter("key");
    ...
    @ResponseBody
    public Map<String, Object> deleteCommonDetail(@PathVariable int no, HttpServletRequest request) {
        String key = request.getParameter("key");
