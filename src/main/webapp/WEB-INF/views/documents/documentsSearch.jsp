...
<div class="form-group col-sm-2 mr-25" style="width: 19%">
    <label for="searchTypeColumn" class="control-label-white col-sm-6 mt13 ml-10" style="text-align:right;">Search items&nbsp;&nbsp; </label>
    <div class="col-sm-6">
...
<div class="form-group col-sm-2 mr-25" style="width: 19%">
    <label for="searchTypeUseYn" class="control-label-white col-sm-6 mt13 ml-10" style="text-align:right;">Show or Hide&nbsp;&nbsp; </label>
    <div class="col-sm-6">
        <select id="searchTypeUseYn" name="searchTypeUseYn" class="form-control" style="background:url(/resources/images/btn_down.png) no-repeat right; background-color:#fafafa;">
            <option value="<%= Constants.SEARCH_TYPE_ALL %>">All</option>
            <option value="<%= Constants.USE_YN_Y %>">Show</option>
            <option value="<%= Constants.USE_YN_N %>">Hide</option>
        </select>
    </div>
</div>
<div class="form-group col-sm-4" style="width: 29%">
    <label for="searchKeyword" class="control-label-white col-sm-3 mt13 ml-10" style="text-align:right;width:29%">Search&nbsp;</label>
    <div class="input-group col-sm-8 ml20">
        <input type="text" maxlength="100" id="searchKeyword" class="form-control2 ml10" placeholder="Please enter your search term." style="width: 97%; background-color: rgb(255, 255, 255);"  onkeypress="procCheckSearchFormKeyEventDocuments(event);">
