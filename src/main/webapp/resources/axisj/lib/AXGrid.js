 ...
 * }
    ...
    getColHeadTd: function (arg) {
        ...
        po.push("class=\"colHeadTd" + arg.bottomClass + sortClass + "\" style=\"height:50px;\">");
        // REX
        // po.push("<div class=\"tdRelBlock\" style=\"height:" + arg.tdHeight + "px;\">");
        po.push("<div class=\"tdRelBlock\" style=\"height:50px;\">");
    ...
    setColHead: function () {
        ...
        if (cfg.viewMode == "grid")
        {
            ...
            this.colHead.find(".colHeadResizer").each(function () {
                ...
                axdom("#" + txtID).css({"padding-top": cellMarginTop - 8 + "px"});
    ...
    setList: function (obj, sortDisable, rewrite, exts) {
        ...
        if (obj.ajaxUrl) {
            ...
            // REX
            var pars = $.extend({}, appendPars, obj.ajaxPars);
            ...
            axf.each(removeList, function (ridx, r) {
                if (_list[r.index]) {
                    if (cfg.passiveRemoveHide) {
                        ...
                        if (_list[r.index].reqCud != "C") {
                            _list[r.index].reqCud = "D";
                        }
                        else {
                            _list[r.index]._isDel = true;
                        }
    ...
    gridBodyOver: function (event) {
        ...
        // REX
        if (this.body.selector == "#AXGridTarget_AX_gridBody") {
            $(".btn_common_code_group_" + this.overedItemIndex).show();
        } else if (this.body.selector == "#AXGridTarget2_AX_gridBody") {
            $(".btn_common_code_detail_" + this.overedItemIndex).show();
        }
    },
    /**
    ...
    gridBodyOut: function (event) {
        ...
        // REX
        if (this.body.selector == "#AXGridTarget_AX_gridBody") {
            $(".btn_common_code_group_" + this.overedItemIndex).hide();
        } else if (this.body.selector == "#AXGridTarget2_AX_gridBody") {
            $(".btn_common_code_detail_" + this.overedItemIndex).hide();
        }
    },
    /**
    ...
    editCell: function (r, c, ii, times, event) {
        ...
        if (CG.editor.createEdit === false && that.item['reqCud'] == 'C') {
            return this;
        }

        if (CG.editor.updateEdit === false && that.item['reqCud'] != 'C') {
            return this;
        }
        ...
        setTimeout(function () {
            ...
            // REX
            if ($(div).children('div').hasClass('createInputCommonCodeGroup')) {
                $('.inline-editor').css('width', '30%');
            }
    ...
    updateItem: function (r, c, itemIndex, value) {
        ...
        // .reqCud 값 조정
        if (_this.list[itemIndex].reqCud != "C" && _this.list[itemIndex].reqCud != "D") {
            var isChanged = false;
    ...
    contentScrollResize: function (resetLeft) {
        ...
        if ("수평스크롤 생성 조건 체크") {
            ...
            if (scrollWidth > (bodyWidth + 10) && cfg.xscroll) {
                show_scroll_x = true;
            }
    ...
    getEditorFormValue: function (form, dataSet, value, key, CH, idAttr) {
        ...
        if (form.type == "hidden") {
            ...
            axf.each(form.options, function (oidx, opt) {
                ...
                // result.push("><label for=\"" + formID + "_AX_" + oidx + "\">" + this.text.dec() + "</label><br/>");
                result.push("><label for=\"" + formID + "_AX_" + oidx + "\">" + this.text.dec() + "</label>");
            });
        }
    ...
    getList: function (filter, clone) {
        ...
        if (filter === false || Object.isUndefined(filter)) {
            ...
            axf.each(this.list, function (idx, item) {
                if (filter.indexOf(item.reqCud) > -1) {
